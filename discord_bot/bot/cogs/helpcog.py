...
SECTIONS = {
    ...
    "Moderation (staff)": [
        ...
        ("mod test <text>", "Dry-run the analyzer + learned filter"),
        ("mod trainspam / trainham", "Teach the learned spam filter (reply or paste)"),
        ("mod filter", "Learned-filter stats and top spam signals"),
